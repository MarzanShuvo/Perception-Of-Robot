...
% YOUR CODE HERE
%here (changed focal_length/referance focal_length)=
%(changed_object_position(d_ref*pos)/ referance object position)
% changed focal_length = (f_ref./d_ref)*(d_ref*position)
